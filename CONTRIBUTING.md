...
**geometrid** is proudly licenced under the MIT license, and so are all
contributions. Please see the [`LICENSE`] file in this directory for more details.

[`LICENSE`]: https://github.com/wainwrightmark/geometrid/blob/main/LICENSE

## Pull Requests

To make changes to **geometrid**, please send in pull requests on GitHub to
...
GitHub](https://github.com/wainwrightmark/geometrid/issues). If you've found a
problem with **geometrid**, please open an issue there.

<!--
We use the following labels:

* `enhancement`: This is for any request for new sections or functionality.
* `bug`: This is for anything that's in `geometrid`, but incorrect or not working.
* `discussion`: A discussion about improving something in `geometrid`; this may
...
Report bugs at https://github.com/wainwrightmark/geometrid/issues.
...
geometrid could always use more documentation, whether as part of the
official geometrid docs, in docstrings, or even on the web in blog posts,
articles, and such.

### Submit Feedback

The best way to send feedback is to file an issue at https://github.com/wainwrightmark/geometrid/issues.
...
Ready to contribute? Here's how to set up `geometrid` for local development.

1. Fork the `geometrid` repo on GitHub.
2. Clone your fork locally:
    ```shell
    $ git clone git@github.com:your_name_here/geometrid.git
    ```
